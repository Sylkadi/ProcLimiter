...
{
    internal class MoltenPerforator
    {
        ...
        private static bool Completed 
        {
            ...
            {
               completed = value;
               if (!value) Log.LogError("Molten perforator hook failed.");
            } 
        }
        ...
        public static void Change()
        {
            IL.RoR2.GlobalEventManager.OnHitEnemy += (il) =>
            {
                ...
                Completed = c.TryGotoNext(v => v.MatchLdsfld("RoR2.RoR2Content/Items", "FireballsOnHit"));
                if (Completed)
                {
