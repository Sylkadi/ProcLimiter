...
{
    internal class ChargedPerforator
    {
        ...
        private static bool Completed 
        {
            ...
            {
               completed = value;
               if (!value) Log.LogError("Charged perforator hook failed.");
            } 
        }
        ...
        public static void Change()
        {
            IL.RoR2.GlobalEventManager.OnHitEnemy += (il) =>
            {
                ...
                Completed = c.TryGotoNext(v => v.MatchLdsfld("RoR2.RoR2Content/Items", "LightningStrikeOnHit"));
                if(Completed)
                {
